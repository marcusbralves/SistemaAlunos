...
public class SistemasAlunos{
	
	public static void main(String[] args) {
		
		
		Collection<diciplinas> disciplina = new ArrayList<diciplinas>();
		...
		diciplinas N = new diciplinas(Integer.parseInt(tmp[0]),tmp[1],Integer.parseInt(tmp[2]));
		disciplina.add(N);
		...
		for(diciplinas N : Aluno.getDiciplinasCursando()) {
	...
	public static void calcularNotas() {
		sistemaalunos.aluno aluno = new aluno();
